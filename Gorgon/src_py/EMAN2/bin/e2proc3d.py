...
#from . import EMAN2
#import EMAN2
#print str(EMAN2.__file__)
#from .EMAN2.libpyem import EMAN2
#from EMAN2 import *
from EMAN2.libpyEM.EMAN2 import *
#from EMAN2.libpyEM.EMAN2 import Region
from optparse import OptionParser

from math import *
import os.path
import EMAN2.pyemtbx.options
...
"""
  ...
  optionlist = EMAN2.pyemtbx.options.get_optionlist(sys.argv[1:])
...
#   avg.process_inplace('normalize.edgemean')
  ...
  logid=EMAN2.libpyEM.EMAN2.E2init(sys.argv,options.ppid)
...
#       plot((curve,curve2))
        ...
        (filtername, param_dict) = EMAN2.libpyEM.EMAN2.parsemodopt(options.process[fi])
        if not param_dict :
...
#                tmp = st.get_image()
    ...
    if options.unstacking:  #output a series numbered single image files
      ...
      if options.append:
        ...
        print "options.outmode " + str(file_mode_map[options.outmode])
