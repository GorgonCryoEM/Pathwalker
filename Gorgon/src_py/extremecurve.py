...
class ExtremeCurveForm(BaseDialogWidget):
    ...
    def openSkeleton(self):
      self.fileName = QtGui.QFileDialog.getOpenFileName(self, self.tr("Open Data"), "", self.tr('Text (*.txt)\nAtom Positions (*.pdb)\nFASTA (*.fas *.fa *.fasta)'))
      skeletonData = []
      ...
      self.vertexPositions = [float(i) for i in self.vertexPositions]
      self.sendRendererPositions()
      ...
      for i in range(len(self.extremalMinPoints)):
          self.app.viewers['calpha'].renderer.makeMin(self.extremalMinPoints[i], True, self.minPointSaliencies[3*i], self.minPointSaliencies[3*i+1], self.minPointSaliencies[3*i+2], self.minPointIntensities[i], self.minPointEigenvalues[i])
      ...
      for i in range(len(self.extremalMaxPoints)):
          self.app.viewers['calpha'].renderer.makeMax(self.extremalMaxPoints[i], True, self.maxPointSaliencies[3*i], self.maxPointSaliencies[3*i+1], self.maxPointSaliencies[3*i+2], self.maxPointIntensities[i], self.maxPointEigenvalues[i])
      ...
      print "storing saddle points..."
      for i in range(len(self.extremalSaddlePoints)):
          self.app.viewers['calpha'].renderer.makeSaddle(self.extremalSaddlePoints[i], True, self.saddlePointSaliencies[3*i], self.saddlePointSaliencies[3*i+1], self.saddlePointSaliencies[3*i+2], self.saddlePointIntensities[i], self.saddlePointEigenvalues[i])
