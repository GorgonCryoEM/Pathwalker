...
class Ui_DialogPathwalker(object):
    def setupUi(self, DialogModelVisualization):
        ...
        self.gridLayout2.addWidget(self.pushButton_9, 12, 3, 1, 1)
        ...
        self.gridLayout2.addWidget(self.tableWidget_2, 11, 0, 1, 4)
        self.pushButton_14 = QtGui.QPushButton(self.tab_3)
        self.pushButton_14.setObjectName(_fromUtf8("pushButton_14"))
        self.gridLayout2.addWidget(self.pushButton_14, 15, 1, 1, 1)
        self.line = QtGui.QFrame(self.tab_3)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.gridLayout2.addWidget(self.line, 4, 0, 1, 4)
        ...
        self.gridLayout2.addWidget(self.tableWidget, 6, 0, 1, 4)
        ...
        self.gridLayout2.addWidget(self.pushButton_7, 8, 0, 1, 3)
        self.pushButton_8 = QtGui.QPushButton(self.tab_3)
        self.pushButton_8.setObjectName(_fromUtf8("pushButton_8"))
        self.gridLayout2.addWidget(self.pushButton_8, 12, 0, 1, 3)
        self.label_15 = QtGui.QLabel(self.tab_3)
        self.label_15.setObjectName(_fromUtf8("label_15"))
        self.gridLayout2.addWidget(self.label_15, 16, 0, 1, 3)
        self.lineEdit_11 = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.gridLayout2.addWidget(self.lineEdit_11, 3, 0, 1, 3)
        self.pushButton_10 = QtGui.QPushButton(self.tab_3)
        self.pushButton_10.setObjectName(_fromUtf8("pushButton_10"))
        self.gridLayout2.addWidget(self.pushButton_10, 13, 0, 1, 3)
        self.checkBox_2 = QtGui.QCheckBox(self.tab_3)
        self.checkBox_2.setObjectName(_fromUtf8("checkBox_2"))
        self.gridLayout2.addWidget(self.checkBox_2, 13, 3, 1, 1)
        self.lineEdit_10 = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_10.setObjectName(_fromUtf8("lineEdit_10"))
        self.gridLayout2.addWidget(self.lineEdit_10, 1, 3, 1, 1)
        self.label_13 = QtGui.QLabel(self.tab_3)
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.gridLayout2.addWidget(self.label_13, 10, 0, 1, 4)
        self.pushButton_12 = QtGui.QPushButton(self.tab_3)
        self.pushButton_12.setObjectName(_fromUtf8("pushButton_12"))
        self.gridLayout2.addWidget(self.pushButton_12, 17, 2, 1, 2)
        self.lineEdit_13 = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_13.setObjectName(_fromUtf8("lineEdit_13"))
        self.lineEdit_13.setEnabled(False)
        self.gridLayout2.addWidget(self.lineEdit_13, 15, 0, 1, 1)
        ...
        self.gridLayout2.addWidget(self.lineEdit_14, 17, 0, 1, 1)
        self.lineEdit_9 = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_9.setObjectName(_fromUtf8("lineEdit_9"))
        self.gridLayout2.addWidget(self.lineEdit_9, 1, 0, 1, 3)
        self.pushButton_5 = QtGui.QPushButton(self.tab_3)
        self.pushButton_5.setObjectName(_fromUtf8("pushButton_5"))
        self.gridLayout2.addWidget(self.pushButton_5, 7, 0, 1, 3)
        self.label = QtGui.QLabel(self.tab_3)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout2.addWidget(self.label, 0, 0, 1, 3)
        self.line_2 = QtGui.QFrame(self.tab_3)
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName(_fromUtf8("line_2"))
        self.gridLayout2.addWidget(self.line_2, 9, 0, 1, 4)
        self.pushButton_6 = QtGui.QPushButton(self.tab_3)
        self.pushButton_6.setObjectName(_fromUtf8("pushButton_6"))
        self.gridLayout2.addWidget(self.pushButton_6, 7, 3, 1, 1)
        self.label_14 = QtGui.QLabel(self.tab_3)
        self.label_14.setObjectName(_fromUtf8("label_14"))
        self.gridLayout2.addWidget(self.label_14, 14, 0, 1, 3)
        self.label_10 = QtGui.QLabel(self.tab_3)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.gridLayout2.addWidget(self.label_10, 2, 0, 1, 3)
        self.lineEdit_12 = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_12.setObjectName(_fromUtf8("lineEdit_12"))
        self.gridLayout2.addWidget(self.lineEdit_12, 3, 3, 1, 1)
        self.checkBox = QtGui.QCheckBox(self.tab_3)
        self.checkBox.setObjectName(_fromUtf8("checkBox"))
        self.gridLayout2.addWidget(self.checkBox, 8, 3, 1, 1)
        self.label_12 = QtGui.QLabel(self.tab_3)
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.gridLayout2.addWidget(self.label_12, 5, 0, 1, 4)
        self.pushButton_4 = QtGui.QPushButton(self.tab_3)
        self.pushButton_4.setObjectName(_fromUtf8("pushButton_4"))
        self.gridLayout2.addWidget(self.pushButton_4, 18, 0, 1, 3)
        self.pushButton_13 = QtGui.QPushButton(self.tab_3)
        self.pushButton_13.setObjectName(_fromUtf8("pushButton_13"))
        self.gridLayout2.addWidget(self.pushButton_13, 17, 1, 1, 1)
        self.pushButton_11 = QtGui.QPushButton(self.tab_3)
        self.pushButton_11.setObjectName(_fromUtf8("pushButton_11"))
        self.gridLayout2.addWidget(self.pushButton_11, 15, 2, 1, 2)
