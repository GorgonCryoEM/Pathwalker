...
class Ui_DialogPathwalker(object):
    ...
    def retranslateUi(self, DialogModelVisualization):
        ...
        self.pushButton_7.setText(_translate("DialogModelVisualization", "Set selected pseudoatom as starting terminus", None))
        self.label_12.setText(_translate("DialogModelVisualization", "Bonds removed (Ctrl + left click multiple pseudoatoms):", None))
        self.lineEdit_13.setText(_translate("DialogModelVisualization", "", None))
        ...
        self.label_14.setText(_translate("DialogModelVisualization", "Set Starting Terminus:", None))
        self.label_15.setText(_translate("DialogModelVisualization", "Set Ending Terminus:", None))
        self.label_13.setText(_translate("DialogModelVisualization", "Bonds created (Ctrl + left click multiple pseudoatoms):", None))
        self.pushButton_6.setText(_translate("DialogModelVisualization", "Create selected bonds", None))
        self.lineEdit_15.setText(_translate("DialogModelVisualization", "", None))
        self.lineEdit_16.setText(_translate("DialogModelVisualization", "", None))
        self.pushButton_8.setText(_translate("DialogModelVisualization", "Set selected pseudoatom as ending terminus", None))
        self.lineEdit_14.setText(_translate("DialogModelVisualization", "", None))
